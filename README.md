...
> ### _Overview_
>
> _릿치는 구로구 주민들이 치과를 선택할 때 광고나 단순한 입소문이 아닌,_

_실제 진료 경험을 바탕으로 신뢰할 수 있는 치과를 선택 할 수 있도록 돕는 예약, 리뷰 서비스입니다._

_예약부터 진료, 리뷰까지 하나의 흐름으로 연결된 구조를 통해 의료 정보의 신뢰도를 높이고자 했습니다._
